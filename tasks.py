...
from tasks_methods.methods import ScraperMethods, ProducerMethods, ExcelOtherMethods
...
def scraper_and_output_file():
    ...
    driver = Selenium()
    initial_search = ScraperMethods.inicial_search(driver=driver,phrase=pay.phrase_test)
    if initial_search:
